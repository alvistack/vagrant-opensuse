...
[![Vagrant Box
download](https://img.shields.io/badge/dynamic/json?label=alvistack%2Fopensuse-leap-16.0&query=%24.boxes%5B%3A1%5D.downloads&url=https%3A%2F%2Fapp.vagrantup.com%2Fapi%2Fv1%2Fsearch%3Fq%3Dalvistack%2Fopensuse-leap-16.0)](https://app.vagrantup.com/alvistack/boxes/opensuse-leap-16.0)
...
- [`alvistack/opensuse-leap-16.0`](https://app.vagrantup.com/alvistack/boxes/opensuse-leap-16.0)
  - [`packer/opensuse-leap-16.0-libvirt/packer.json`](https://github.com/alvistack/vagrant-opensuse/blob/master/packer/opensuse-leap-16.0-libvirt/packer.json)
  - [`packer/opensuse-leap-16.0-virtualbox/packer.json`](https://github.com/alvistack/vagrant-opensuse/blob/master/packer/opensuse-leap-16.0-virtualbox/packer.json)
...
directory](https://learn.hashicorp.com/tutorials/vagrant/getting-started-project-setup?in=vagrant/getting-started):
    ...
    # Initialize Vagrant
    vagrant init alvistack/opensuse-leap-16.0
...
[Libvirt](https://libvirt.org/) installed, e.g.
    ...
    # Run Molecule on openSUSE Leap 16.0
    molecule converge -s opensuse-16.0-libvirt
